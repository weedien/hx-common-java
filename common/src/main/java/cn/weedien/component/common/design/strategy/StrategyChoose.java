...
public class StrategyChoose implements CommandLineRunner {
    ...
    public StrategyChoose(ApplicationContext applicationContext) {
    ...
    public void run(String... args) throws Exception {
        Map<String, ExecuteStrategy> actual = applicationContext.getBeansOfType(ExecuteStrategy.class);
